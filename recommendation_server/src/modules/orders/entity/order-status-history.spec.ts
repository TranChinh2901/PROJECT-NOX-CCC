...
describe('OrderStatusHistory Entity', () => {
  it('should create an OrderStatusHistory instance', () => {
    ...
    expect(history).toBeInstanceOf(OrderStatusHistory);
  });
  ...
  it('should accept valid order status values', () => {
    ...
    expect(history.status).toBe(OrderStatus.PENDING);
    
    history.status = OrderStatus.CONFIRMED;
  ...
  it('should accept nullable fields', () => {
    ...
    history.previous_status = OrderStatus.PENDING;
  ...
  it('should have a relationship with Order', () => {
    ...
    expect(history.order).toBeInstanceOf(Order);
